...
import styles from '../../styles/VenueSection/WeddingVision.module.css';
...
const WeddingVision = () => {
    ...
    return (
        <section className={`${styles.MainContainer} mt-4`}>
            <div className={styles.featuredSection}>
                <Container>
                    <h2 className={`${styles.heading} Adamina400 py-5`}>
                        Featured Places to <span>Your Wedding Vision</span>
                    </h2>
                            ...
                            <Col key={index} lg={3} md={4} sm={4} xs={12} className="mb-4">
                                <Card className={`${styles123.card} h-100`}>
                                    <div className={`${styles123.badge}`}>
                                        <BiSolidDiscount className={styles.featuredIcon} />
